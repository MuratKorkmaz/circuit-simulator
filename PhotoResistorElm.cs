...
class PhotoResistorElm:CircuitElm
{
	...
	public PhotoResistorElm(int xa, int ya, int xb, int yb, int f, SupportClass.Tokenizer st):base(xa, ya, xb, yb, f)
	{
	...
	internal virtual void  createSlider()
	{
		...
		temp_Label2.Text = "Уровень света";
