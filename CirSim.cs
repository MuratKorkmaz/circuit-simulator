...
namespace circuit_emulator
{
    ...
    public class CirSim:System.Windows.Forms.Form
    {
        ...
        internal static System.String muString = "РјРє";
        internal static System.String ohmString = "РћРј";
        ...
        public virtual void  init()
        {
            ...
            System.Windows.Forms.MenuItem m = new System.Windows.Forms.MenuItem("Р¤Р°Р№Р»");
            if (useFrame)
                mb.MenuItems.Add(m);
            else
                mainMenu.MenuItems.Add(m);
            m.MenuItems.Add(importItem = getMenuItem("РРјРїРѕСЂС‚"));
            m.MenuItems.Add(exportItem = getMenuItem("Р­РєСЃРїРѕСЂС‚"));
            m.MenuItems.Add(exportLinkItem = getMenuItem("Р­РєСЃРїРѕСЂС‚. СЃСЃС‹Р»РєСѓ"));
            m.MenuItems.Add(new System.Windows.Forms.MenuItem("-"));
            m.MenuItems.Add(exitItem = getMenuItem("Р’С‹С…РѕРґ"));
		
            m = new System.Windows.Forms.MenuItem("РџСЂР°РІРєР°");
            m.MenuItems.Add(undoItem = getMenuItem("РћС‚РјРµРЅРёС‚СЊ"));
            ...
            m.MenuItems.Add(redoItem = getMenuItem("РџРѕРІС‚РѕСЂРёС‚СЊ"));
            //UPGRADE_TODO: The equivalent in .NET for constructor 'java.awt.MenuShortcut.MenuShortcut' may return a different value. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
            ...
            m.MenuItems.Add(new System.Windows.Forms.MenuItem("-"));
            m.MenuItems.Add(cutItem = getMenuItem("Р’С‹СЂРµР·Р°С‚СЊ"));
            //UPGRADE_TODO: The equivalent in .NET for constructor 'java.awt.MenuShortcut.MenuShortcut' may return a different value. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
            ...
            m.MenuItems.Add(copyItem = getMenuItem("РљРѕРїРёСЂРѕРІР°С‚СЊ"));
            //UPGRADE_TODO: The equivalent in .NET for constructor 'java.awt.MenuShortcut.MenuShortcut' may return a different value. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
            ...
            m.MenuItems.Add(pasteItem = getMenuItem("Р’СЃС‚Р°РІРёС‚СЊ"));
            //UPGRADE_TODO: The equivalent in .NET for constructor 'java.awt.MenuShortcut.MenuShortcut' may return a different value. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
            ...
            m.MenuItems.Add(selectAllItem = getMenuItem("Р’С‹Р±СЂР°С‚СЊ РІСЃС‘"));
            //UPGRADE_TODO: The equivalent in .NET for constructor 'java.awt.MenuShortcut.MenuShortcut' may return a different value. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
            ...
            m = new System.Windows.Forms.MenuItem("РћСЃС†РёР»Р»РѕРіСЂР°С„");
            if (useFrame)
                mb.MenuItems.Add(m);
            else
                mainMenu.MenuItems.Add(m);
            m.MenuItems.Add(getMenuItem("РћР±СЉРµРґРёРЅРёС‚СЊ РІСЃС‘", "stackAll"));
            m.MenuItems.Add(getMenuItem("Р Р°Р·СЉРµРґРёРЅРёС‚СЊ РІСЃС‘", "unstackAll"));
		
            optionsMenu = m = new System.Windows.Forms.MenuItem("РќР°СЃС‚СЂРѕР№РєРё");
            if (useFrame)
                mb.MenuItems.Add(m);
            else
                mainMenu.MenuItems.Add(m);
            m.MenuItems.Add(dotsCheckItem = getCheckItem("РџРѕРєР°Р·С‹РІР°С‚СЊ С‚РѕРє"));
            dotsCheckItem.Checked = true;
            m.MenuItems.Add(voltsCheckItem = getCheckItem("РџРѕРєР°Р·С‹РІР°С‚СЊ РЅР°РїСЂСЏР¶РµРЅРёРµ"));
            voltsCheckItem.Checked = true;
            m.MenuItems.Add(powerCheckItem = getCheckItem("РџРѕРєР°Р·С‹РІР°С‚СЊ РјРѕС‰РЅРѕСЃС‚СЊ"));
            m.MenuItems.Add(showValuesCheckItem = getCheckItem("РџРѕРєР°Р·С‹РІР°С‚СЊ Р·РЅР°С‡РµРЅРёСЏ"));
            showValuesCheckItem.Checked = true;
            //m.add(conductanceCheckItem = getCheckItem("Show Conductance"));
            m.MenuItems.Add(smallGridCheckItem = getCheckItem("РњРµР»РєР°СЏ СЃРµС‚РєР°"));
            m.MenuItems.Add(euroResistorCheckItem = getCheckItem("Р РµР·РёСЃС‚РѕСЂС‹ РїРѕ Р“РћРЎРў")); //must be default in russia
            euroResistorCheckItem.Checked = euro;
            m.MenuItems.Add(printableCheckItem = getCheckItem("Р‘РµР»С‹Р№ С„РѕРЅ"));
            printableCheckItem.Checked = printable;
            m.MenuItems.Add(conventionCheckItem = getCheckItem("РћР±С‰РµРїСЂРёРЅСЏС‚РѕРµ РЅР°РїСЂР°РІР»РµРЅРёРµ С‚РѕРєР°"));
            conventionCheckItem.Checked = convention;
            m.MenuItems.Add(optionsItem = getMenuItem("Р”СЂСѓРіРёРµ РЅР°СЃС‚СЂРѕР№РєРё..."));
		
            System.Windows.Forms.MenuItem circuitsMenu = new System.Windows.Forms.MenuItem("РЎС…РµРјС‹");
            if (useFrame)
                mb.MenuItems.Add(circuitsMenu);
            else
                mainMenu.MenuItems.Add(circuitsMenu);
		
            mainMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РЎРѕРµРґРёРЅРµРЅРёРµ", "WireElm"));
            mainMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р РµР·РёСЃС‚РѕСЂ", "ResistorElm"));
		
            System.Windows.Forms.MenuItem passMenu = new System.Windows.Forms.MenuItem("РџР°СЃСЃРёРІРЅС‹Рµ РєРѕРјРїРѕРЅРµРЅС‚С‹");
            mainMenu.MenuItems.Add(passMenu);
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РљРѕРЅРґРµРЅСЃР°С‚РѕСЂ", "CapacitorElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РРЅРґСѓРєС‚РёРІРЅРѕСЃС‚СЊ", "InductorElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р’С‹РєР»СЋС‡Р°С‚РµР»СЊ", "SwitchElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РљРЅРѕРїРѕС‡РЅС‹Р№ РІС‹РєР»СЋС‡Р°С‚РµР»СЊ", "PushSwitchElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РџРµСЂРµРєР»СЋС‡Р°С‚РµР»СЊ", "Switch2Elm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РџРµСЂРµРјРµРЅРЅРѕРµ СЃРѕРїСЂРѕС‚РёРІР»РµРЅРёРµ", "PotElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўСЂР°РЅСЃС„РѕСЂРјР°С‚РѕСЂ", "TransformerElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўСЂР°РЅСЃС„РѕСЂРјР°С‚РѕСЂ СЃ РѕС‚РІРѕРґРѕРј", "TappedTransformerElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р›РёРЅРёСЋ РїРµСЂРµРґР°С‡Рё", "TransLineElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р РµР»Рµ", "RelayElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РњРµРјСЂРёСЃС‚РѕСЂ", "MemristorElm"));
            passMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РСЃРєСЂРѕРІРѕР№ РїСЂРѕРјРµР¶СѓС‚РѕРє", "SparkGapElm"));
		
            System.Windows.Forms.MenuItem inputMenu = new System.Windows.Forms.MenuItem("Р’С…РѕРґС‹/Р’С‹С…РѕРґС‹");
            mainMenu.MenuItems.Add(inputMenu);
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р—Р°Р·РµРјР»РµРЅРёРµ", "GroundElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РСЃС‚. РїРѕСЃС‚РѕСЏРЅРЅРѕРіРѕ С‚РѕРєР° (2-РІС‹РІРѕРґР°)", "DCVoltageElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РСЃС‚. РїРµСЂРµРјРµРЅРЅРѕРіРѕ С‚РѕРєР° (2-РІС‹РІРѕРґР°)", "ACVoltageElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РСЃС‚. РЅР°РїСЂСЏР¶РµРЅРёСЏ (1-РІС‹РІРѕРґ)", "RailElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РСЃС‚. РїРµСЂРµРјРµРЅРЅРѕРіРѕ С‚РѕРєР° (1-РІС‹РІРѕРґ)", "ACRailElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РСЃС‚. РџСЂСЏРјРѕСѓРі. РЅР°РїСЂСЏР¶РµРЅРёСЏ (1-РІС‹РІРѕРґ)", "SquareRailElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РђРЅР°Р»РѕРіРѕРІС‹Р№ РІС‹С…РѕРґ", "OutputElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р›РѕРіРёС‡РµСЃРєРёР№ РІС…РѕРґ", "LogicInputElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р›РѕРіРёС‡РµСЃРєРёР№ РІС‹С…РѕРґ", "LogicOutputElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўР°РєС‚РѕРІС‹Рµ РёРјРїСѓР»СЊСЃС‹", "ClockElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РЎРІРёРї", "SweepElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р РµРіСѓР»РёСЂСѓРµРјРѕРµ РЅР°РїСЂСЏР¶РµРЅРёРµ", "VarRailElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РђРЅС‚РµРЅРЅСѓ", "AntennaElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РСЃС‚РѕС‡РЅРёРє С‚РѕРєР°", "CurrentElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РЎРІРµС‚РѕРґРёРѕРґ", "LEDElm"));
            inputMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р›Р°РјРїСѓ (beta)", "LampElm"));
		
            System.Windows.Forms.MenuItem activeMenu = new System.Windows.Forms.MenuItem("РђРєС‚РёРІРЅС‹Рµ РєРѕРјРїРѕРЅРµРЅС‚С‹");
            mainMenu.MenuItems.Add(activeMenu);
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р”РёРѕРґ", "DiodeElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РЎС‚Р°Р±РёР»РёС‚СЂРѕРЅ", "ZenerElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўСЂР°РЅР·РёСЃС‚РѕСЂ (Р±РёРїРѕР»СЏСЂРЅС‹Р№, NPN)", "NTransistorElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўСЂР°РЅР·РёСЃС‚РѕСЂ (Р±РёРїРѕР»СЏСЂРЅС‹Р№, PNP)", "PTransistorElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РћРїРµСЂР°С†РёРѕРЅРЅС‹Р№ СѓСЃРёР»РёС‚РµР»СЊ (- РІРІРµСЂС…Сѓ)", "OpAmpElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РћРїРµСЂР°С†РёРѕРЅРЅС‹Р№ СѓСЃРёР»РёС‚РµР»СЊ (+ РІРІРµСЂС…Сѓ)", "OpAmpSwapElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ MOSFET (n-РєР°РЅР°Р»СЊРЅС‹Р№)", "NMosfetElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ MOSFET (p-РєР°РЅР°Р»СЊРЅС‹Р№)", "PMosfetElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РџРѕР»РµРІРѕР№ С‚СЂР°РЅР·РёСЃС‚РѕСЂ (n-РєР°РЅР°Р»СЊРЅС‹Р№)", "NJfetElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РџРѕР»РµРІРѕР№ С‚СЂР°РЅР·РёСЃС‚РѕСЂ (p-РєР°РЅР°Р»СЊРЅС‹Р№)", "PJfetElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РђРЅР°Р»РѕРіРѕРІС‹Р№ РІС‹РєР»СЋС‡Р°С‚РµР»СЊ", "AnalogSwitchElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РђРЅР°Р»РѕРіРѕРІС‹Р№ РїРµСЂРµРєР»СЋС‡Р°С‚РµР»СЊ", "AnalogSwitch2Elm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўРёСЂРёСЃС‚РѕСЂ", "SCRElm"));
            //activeMenu.add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р’Р°СЂРёРєР°Рї", "VaractorElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўСѓРЅРЅРµР»СЊРЅС‹Р№ РґРёРѕРґ", "TunnelDiodeElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўСЂРёРѕРґ", "TriodeElm"));
            //activeMenu.add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р”РёРЅРёСЃС‚РѕСЂ", "DiacElm"));
            //activeMenu.add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РЎРёРјРёСЃС‚РѕСЂ", "TriacElm"));
            //activeMenu.add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р¤РѕС‚РѕСЂРµР·РёСЃС‚РѕСЂ", "PhotoResistorElm"));
            //activeMenu.add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўРµСЂРјРёСЃС‚РѕСЂ", "ThermistorElm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ CCII+", "CC2Elm"));
            activeMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ CCII-", "CC2NegElm"));
		
            System.Windows.Forms.MenuItem gateMenu = new System.Windows.Forms.MenuItem("Р›РѕРіРёС‡РµСЃРєРёРµ СЌР»РµРјРµРЅС‚С‹");
            mainMenu.MenuItems.Add(gateMenu);
            gateMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РРЅРІРµСЂС‚РѕСЂ", "InverterElm"));
            gateMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ СЌР»РµРјРµРЅС‚ Р-РќР•", "NandGateElm"));
            gateMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ СЌР»РµРјРµРЅС‚ РР›Р-РќР•", "NorGateElm"));
            gateMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ СЌР»РµРјРµРЅС‚ Р", "AndGateElm"));
            gateMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ СЌР»РµРјРµРЅС‚ РР›Р", "OrGateElm"));
            gateMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ СЌР»РµРјРµРЅС‚ РёСЃРєР»СЋС‡Р°СЋС‰РµРµ РР›Р", "XorGateElm"));
		
            System.Windows.Forms.MenuItem chipMenu = new System.Windows.Forms.MenuItem("РњРёРєСЂРѕСЃС…РµРјС‹");
            mainMenu.MenuItems.Add(chipMenu);
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ D С‚СЂРёРіРіРµСЂ", "DFlipFlopElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ JK С‚СЂРёРіРіРµСЂ", "JKFlipFlopElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ 7РјРё СЃРµРіРјРµРЅС‚РЅС‹Р№ СЃРІРµС‚РѕРґРёРѕРґ", "SevenSegElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ VCO", "VCOElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р¤Р°Р·РѕРІС‹Р№ РєРѕРјРїР°СЂР°С‚РѕСЂ", "PhaseCompElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РЎС‡РµС‚С‡РёРє", "CounterElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р”РµРєР°РґРЅС‹Р№ СЃС‡РµС‚С‡РёРє", "DecadeElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ 555 РўР°Р№РјРµСЂ", "TimerElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р¦РђРџ", "DACElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РђР¦Рџ", "ADCElm"));
            chipMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ Р—Р°С‰РµР»РєСѓ", "LatchElm"));
		
            System.Windows.Forms.MenuItem otherMenu = new System.Windows.Forms.MenuItem("РџСЂРѕС‡РµРµ");
            mainMenu.MenuItems.Add(otherMenu);
            otherMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РўРµРєСЃС‚", "TextElm"));
            otherMenu.MenuItems.Add(getClassCheckItem("Р”РѕР±Р°РІРёС‚СЊ РїСЂРѕР±Сѓ РѕСЃС†РёР»Р»РѕРіСЂР°С„Р°", "ProbeElm"));
            ...
            mainMenu.MenuItems.Add(getCheckItem("Р’С‹Р±РѕСЂ/РїРµСЂРµС‚Р°СЃРєРёРІР°РЅРёРµ РІС‹Р±СЂР°РЅРЅРѕРіРѕ (РїСЂРѕР±РµР» РёР»Рё Shift+С‰РµР»С‡РѕРє)", "Select"));
            main.ContextMenu = mainMenu;
		
            System.Windows.Forms.Button temp_Button2;
            temp_Button2 = new System.Windows.Forms.Button();
            temp_Button2.Text = "РЎР±СЂРѕСЃ";
            //UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
            ...
            stoppedCheck = SupportClass.CheckBoxSupport.CreateCheckBox("РћСЃС‚Р°РЅРѕРІР»РµРЅРѕ");
            ...
            temp_Label2.Text = "РЎРєРѕСЂРѕСЃС‚СЊ СЃРёРјСѓР»СЏС†РёРё";
            ...
            temp_Label4.Text = "РЎРєРѕСЂРѕСЃС‚СЊ С‚РѕРєР°";
            ...
            temp_Label6.Text = "РЇСЂРєРѕСЃС‚СЊ РјРѕС‰РЅРѕСЃС‚Рё";
            ...
            temp_Label10.Text = "РџРµСЂРµРІРѕРґ licrym.org";
            //UPGRADE_TODO: Method 'java.awt.Container.add' was converted to 'System.Windows.Forms.ContainerControl.Controls.Add' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaawtContaineradd_javaawtComponent'"
            ...
            elmMenu.MenuItems.Add(elmEditMenuItem = getMenuItem("РџР°СЂР°РјРµС‚СЂС‹"));
            elmMenu.MenuItems.Add(elmScopeMenuItem = getMenuItem("РЎРјРѕС‚СЂРµС‚СЊ РІ РѕСЃС†РёР»Р»РѕРіСЂР°С„Рµ"));
            elmMenu.MenuItems.Add(elmCutMenuItem = getMenuItem("Р’С‹СЂРµР·Р°С‚СЊ"));
            elmMenu.MenuItems.Add(elmCopyMenuItem = getMenuItem("РљРѕРїРёСЂРѕРІР°С‚СЊ"));
            elmMenu.MenuItems.Add(elmDeleteMenuItem = getMenuItem("РЈРґР°Р»РёС‚СЊ"));
        ...
        internal virtual System.Windows.Forms.ContextMenu buildScopeMenu(bool t)
        {
            ...
            m.MenuItems.Add(getMenuItem("РЈР±СЂР°С‚СЊ", "remove"));
            m.MenuItems.Add(getMenuItem("РЎРєРѕСЂРѕСЃС‚СЊ 2x", "speed2"));
            m.MenuItems.Add(getMenuItem("РЎРєРѕСЂРѕСЃС‚СЊ 1/2x", "speed1/2"));
            m.MenuItems.Add(getMenuItem("РњР°СЃС€С‚Р°Р± 2x", "scale"));
            m.MenuItems.Add(getMenuItem("РњР°РєСЃРёРјР°Р»СЊРЅС‹Р№ РјР°СЃС€С‚Р°Р±", "maxscale"));
            m.MenuItems.Add(getMenuItem("РћР±СЉРµРґРёРЅРёС‚СЊ", "stack"));
            m.MenuItems.Add(getMenuItem("Р Р°Р·СЉРµРґРёРЅРёС‚СЊ", "unstack"));
            m.MenuItems.Add(getMenuItem("РЎР±СЂРѕСЃ", "reset"));
            if (t)
            {
                m.MenuItems.Add(scopeIbMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ IР±"));
                m.MenuItems.Add(scopeIcMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ IРє"));
                m.MenuItems.Add(scopeIeMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ IСЌ"));
                m.MenuItems.Add(scopeVbeMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ VР±СЌ"));
                m.MenuItems.Add(scopeVbcMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ VР±Рє"));
                m.MenuItems.Add(scopeVceMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ VРєСЌ"));
                m.MenuItems.Add(scopeVceIcMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ VРєСЌ Рё IРє"));
            }
            else
            {
                m.MenuItems.Add(scopeVMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ РќР°РїСЂСЏР¶РµРЅРёРµ"));
                m.MenuItems.Add(scopeIMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ РўРѕРє"));
                m.MenuItems.Add(scopePowerMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ РџРѕС‚СЂРµР±Р»РµРЅРЅСѓСЋ РјРѕС‰РЅРѕСЃС‚СЊ"));
                m.MenuItems.Add(scopeMaxMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ РџРёРєРѕРІРѕРµ Р·РЅР°С‡РµРЅРёРµ"));
                m.MenuItems.Add(scopeMinMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ РћС‚СЂРёС†Р°С‚РµР»СЊРЅРѕРµ РїРёРєРѕРІРѕРµ Р·РЅР°С‡РµРЅРёРµ"));
                m.MenuItems.Add(scopeFreqMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ Р§Р°СЃС‚РѕС‚Сѓ"));
                m.MenuItems.Add(scopeVIMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ V Рё I"));
                m.MenuItems.Add(scopeXYMenuItem = getCheckItem("Р“СЂР°С„РёРє X/Y"));
                m.MenuItems.Add(scopeSelectYMenuItem = getMenuItem("РџРѕРєР°Р·Р°С‚СЊ Y", "selecty"));
                m.MenuItems.Add(scopeResistMenuItem = getCheckItem("РџРѕРєР°Р·Р°С‚СЊ РЎРѕРїСЂРѕС‚РёРІР»РµРЅРёРµ"));
            }
            main.ContextMenu = m;
            return m;
        }
		...
		*/
        ...
        internal virtual void  analyzeCircuit()
        {
            ...
            while (changed)
            {
                ...
                for (i = 0; i != nodeList.Count; i++)
                    ...
                    {
                        System.Console.Out.WriteLine("СѓР·РµР» " + i + " РЅРµ РїРѕРґРєР»СЋС‡РµРЅ");
            ...
            for (i = 0; i != elmList.Count; i++)
            {
                ...
                if (ce is InductorElm)
                {
                    ...
                    if (!fpi.findPath(ce.getNode(0), 5) && !fpi.findPath(ce.getNode(0)))
                    {
                        ...
                        System.Console.Out.WriteLine(ce + " РЅРµС‚ РїСѓС‚Рё");
                        ce.reset();
                    }
                }
        ...
        internal virtual void  stampResistor(int n1, int n2, double r)
        {
            ...
            {
                System.Console.Out.Write("РїР»РѕС…РѕРµ СЃРѕРїСЂРѕС‚РёРІР»РµРЅРёРµ " + r + " " + r0 + "\n");
                int a = 0;
                a /= a;
            }
        ...
        public virtual void  actionPerformed(System.Object event_sender, System.EventArgs e)
        {
            ...
            if (event_sender == redoItem)
                doRedo();
            if (String.CompareOrdinal(ac, "Р’С‹СЂРµР·Р°С‚СЊ") == 0)
            {
                if (event_sender != elmCutMenuItem)
                    menuElm = null;
                doCut();
            }
            if (String.CompareOrdinal(ac, "РљРѕРїРёСЂРѕРІР°С‚СЊ") == 0)
            {
                if (event_sender != elmCopyMenuItem)
                    menuElm = null;
                doCopy();
            }
            if (String.CompareOrdinal(ac, "Р’СЃС‚Р°РІРёС‚СЊ") == 0)
                doPaste();
