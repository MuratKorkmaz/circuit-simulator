...
//ORIGINAL LINE: double parseUnits(EditInfo ei) throws java.text.ParseException
        ...
        public virtual void actionPerformed(EventArgs e) //ActionEvent
        {
            int i;
            object src = e.ToString();
            for (i = 0; i != einfocount; i++)
            {
                EditInfo ei = einfos[i];
                if (src == ei.textf)
        ...
        public virtual void adjustmentValueChanged(EventArgs e) //AdjustmentEvent
        {
            //object src = e.Source;
            int i;
            for (i = 0; i != einfocount; i++)
...
//		ei.value = Math.round(ei.value*100)/100.;
        ...
        public virtual void itemStateChanged(EventArgs  e)//ItemEvent
        {
        ...
        public virtual bool handleEvent(EventArgs  ev)//Event
        {
