...
//codepage UTF-8
    ...
    public class CirSim : Frame, ComponentListener, ActionListener, AdjustmentListener, MouseMotionListener, MouseListener, ItemListener, KeyListener
    {

        internal Thread engine = null;

        internal Dimension winSize;
        ...
        internal CheckboxMenuItem scopeMinMenuItem;
        internal CheckboxMenuItem scopeFreqMenuItem;
        internal CheckboxMenuItem scopePowerMenuItem;
        internal CheckboxMenuItem scopeIbMenuItem;
        internal CheckboxMenuItem scopeIcMenuItem;
        internal CheckboxMenuItem scopeIeMenuItem;
        internal CheckboxMenuItem scopeVbeMenuItem;
        internal CheckboxMenuItem scopeVbcMenuItem;
        internal CheckboxMenuItem scopeVceMenuItem;
        internal CheckboxMenuItem scopeVIMenuItem;
        internal CheckboxMenuItem scopeXYMenuItem;
